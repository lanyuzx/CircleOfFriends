...
@implementation LLCircleOfFriendsViewModel
...
- (NSArray *)creatModelsWithCount:(NSInteger)count
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        LLCircleOfFriendsModel *model = [LLCircleOfFriendsModel new];
        ...
        for (int i = 0; i < likeRandom; i++) {
            LLLikeItemModel *model = [LLLikeItemModel new];
            int index = arc4random_uniform((int)namesArray.count);
...
-(NSMutableArray<LLCircleOfFriendsModel *> *)itemModels {
    if (!_itemModels) {
